...
$PID=-1;
$ps_command = "ps aux | grep [s]erver_script_uniqueid.php"; // set up command
$file_location = "/data/individual_project/php/server_script/"
	       	."uniqueid/server_script_uniqueid.php";
...
function check_packet_transmission(&$buffer) {
  $vm_ip_port = "".$GLOBALS['port'].":"; // redacted
